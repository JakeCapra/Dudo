...
alter table players add constraint color_hex_constraint check (color ~* '^#[a-f0-9]{6}$');

-- Add constraint to games.host
alter table games add constraint games_host_fkey foreign key (host_player_id) references players(id);
